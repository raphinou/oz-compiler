...
For example, infix arithmetic operators are transformed in the call of their respective function.
...
If no side is elementary, a new synthetic variable is declared and unified with each side respectively.
