...
\lstinline!ResolveOverload!\footnote{https://github.com/mozart/mozart2/blob/master/lib/compiler/NewAssembler.oz\#L165} 
...
Support for logic programming features of Oz also have to be added, though this not yet supported by the new virtual machine.
